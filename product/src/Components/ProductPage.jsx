...
function ProductPage({loading, setLoading}) {
                    ...
                    <div className="md:flex-1 px-4">
                        ...
                        <div className="flex py-4 space-x-4">
                            ...
                            <Link to={`/orders/${productId}/checkout`} state={{ product }}>
                                <button type="button" className="h-14 px-6 py-2 font-semibold rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white">Buy Now</button>
                            </Link>
                        </div>
                    </div>
                </div>
